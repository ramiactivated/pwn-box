...
Ejecución Condicional: * Lanza WPScan solo si detecta la huella wp-content en el código fuente.
...
Requisitos previos: Instalar Packer y VirtualBox en tu sistema anfitrión.
